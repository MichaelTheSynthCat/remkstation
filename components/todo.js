    ...
    return (
        <tr className="flex gap-4 border-b py-2">
            ...
            <td className="">
                <label className="">
                    <input
                        className="w-6 h-6 transition-all ease-linear hover:ring-4 ring-highlight"
                        type="checkbox"
                        checked={checked}
            ...
            <td>
                <button onClick={handleRemove}>
                    <AiFillDelete className="text-2xl ease-linear transition-colors hover:text-red-600" />
                </button>
            </td>
        </tr>
    );
...
export default function ToDoList() {
    const [entries, setEntries] = useState(
        typeof window !== "undefined" ? loadData() : []
    );
    ...
    return (
        <div
            className="flex flex-col gap-2 p-5 bg-primary border border-white shadow-lg shadow-highlight_darker 
        ...
        >
            ...
            <div className="">
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="text-xl my_text_anim my_button p-1"
                    >
                        Add
                    </button>
                </form>
